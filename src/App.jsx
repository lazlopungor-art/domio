...
export default function App() {
  ...
  const Header = () => (
    <header style={{
      ...
      <div onClick={() => { setPage("home"); setMenuOpen(false) }} style={{ display: "flex", alignItems: "center", gap: "0.75rem", cursor: "pointer" }}>
        ...
        <div>
          ...
          <div style={{ color: "rgba(212,189,150,0.4)", fontSize: 8, letterSpacing: "0.2em", textTransform: "uppercase" }}>Rédaction Immobilière</div>
        </div>
      </div>
      ...
      <div style={{ maxWidth: 1000, margin: "-1.5rem auto 0", padding: "0 1rem 3rem", display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(300px, 1fr))", gap: "1rem", position: "relative", zIndex: 1 }}>
        ...
        <div style={{ background: "#FFFDF9", borderRadius: 2, border: "1px solid #E8DFCF", boxShadow: "0 4px 20px rgba(44,36,22,0.1)", overflow: "hidden" }}>
          <div style={{ padding: "1rem 1.25rem", borderBottom: "1px solid #E8DFCF", background: "#F5F0E8" }}>
            <div style={{ fontSize: 10, letterSpacing: "0.2em", textTransform: "uppercase", color: "#8B7355" }}>◈ &nbsp; Détails du bien</div>
          </div>
          <div style={{ padding: "1.25rem", display: "flex", flexDirection: "column", gap: "1rem" }}>
              ...
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr 1fr", gap: "0.35rem", marginTop: 6 }}>
                {types.map(t => (
                  <button key={t.id} onClick={() => setTypeContenu(t.id)} style={{
                    padding: "0.5rem 0.1rem", border: typeContenu === t.id ? "1px solid #8B7355" : "1px solid #E8DFCF",
                    background: typeContenu === t.id ? "#2C2416" : "#FAF7F2",
                    color: typeContenu === t.id ? "#D4BD96" : "#8B7355",
                    borderRadius: 2, cursor: "pointer", fontSize: 10, letterSpacing: "0.05em",
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "0.75rem" }}>
              <div>
                <div style={labelStyle}>Type de bien</div>
            ...
            <div>
              <div style={labelStyle}>Atouts du bien</div>
              <textarea value={points} onChange={e => setPoints(e.target.value)} placeholder="Jardin, cuisine rénovée, lumineux..." style={{ ...inputStyle, height: 70, resize: "none" }} />
            </div>
            <div>
              ...
              <div style={{ display: "flex", gap: "0.4rem", marginTop: 6 }}>
                {tons.map(t => (
                  <button key={t.id} onClick={() => setTon(t.id)} style={{
                    ...
                    border: ton === t.id ? "1px solid #8B7355" : "1px solid #E8DFCF",
                    background: ton === t.id ? "#F5F0E8" : "#FAF7F2",
                    color: ton === t.id ? "#2C2416" : "#A89070",
                    borderRadius: 2, cursor: "pointer", fontSize: 10,
                    letterSpacing: "0.05em", textTransform: "uppercase",
                    fontFamily: "inherit", fontWeight: ton === t.id ? "bold" : "normal"
                  }}>{t.label}</button>
                ))}
              </div>
            </div>
        ...
        <div style={{ background: "#FFFDF9", borderRadius: 2, border: "1px solid #E8DFCF", boxShadow: "0 4px 20px rgba(44,36,22,0.1)", display: "flex", flexDirection: "column", overflow: "hidden", minHeight: 300 }}>
          <div style={{ padding: "1rem 1.25rem", borderBottom: "1px solid #E8DFCF", background: "#F5F0E8", display: "flex", alignItems: "center", justifyContent: "space-between" }}>
            <div style={{ fontSize: 10, letterSpacing: "0.2em", textTransform: "uppercase", color: "#8B7355" }}>◈ &nbsp; Votre contenu</div>
            {resultat && <div style={{ fontSize: 9, letterSpacing: "0.15em", textTransform: "uppercase", color: "#8B7355", border: "1px solid #C8B898", padding: "2px 8px", borderRadius: 20 }}>✓ Prêt</div>}
          </div>
          <div style={{ padding: "1.25rem", flex: 1, overflowY: "auto" }}>
            {!resultat && !loading && (
              <div style={{ minHeight: 200, display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", gap: "1rem", textAlign: "center" }}>
                ...
                <div style={{ color: "#B8A88A", fontSize: "0.82rem", lineHeight: 1.7, maxWidth: 180 }}>Renseignez les informations et générez votre contenu</div>
              </div>
            )}
            {loading && (
              <div style={{ minHeight: 200, display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", gap: "1rem" }}>
                ...
                <div style={{ color: "#A89070", fontSize: "0.8rem", letterSpacing: "0.1em", textTransform: "uppercase" }}>Rédaction en cours</div>
              </div>
            )}
            {resultat && (
              <div>
  ...
  return (
    <div style={{ minHeight: "100vh", background: "#FAF7F2", fontFamily: "Georgia, serif" }}>
      ...
      {/* HERO */}
      <div style={{ background: "linear-gradient(180deg, #2C2416 0%, #3D3020 65%, #FAF7F2 100%)", padding: "3.5rem 1.5rem 5rem", textAlign: "center", position: "relative", overflow: "hidden" }}>
        <div style={{ color: "rgba(212,189,150,0.5)", fontSize: 10, letterSpacing: "0.25em", textTransform: "uppercase", marginBottom: "1.25rem" }}>✦ &nbsp; L'art de la rédaction immobilière &nbsp; ✦</div>
        <h1 style={{ color: "#FAF7F2", fontSize: "clamp(1.6rem, 5vw, 2.8rem)", fontWeight: "normal", lineHeight: 1.2, marginBottom: "1.25rem" }}>
          Rédigez vos annonces<br />immobilières en{" "}
          <span style={{ color: "#D4BD96", fontStyle: "italic" }}>10 secondes</span>
        </h1>
        <p style={{ color: "rgba(250,247,242,0.6)", fontSize: "clamp(0.85rem, 2.5vw, 1rem)", marginBottom: "2rem", maxWidth: 500, margin: "0 auto 2rem" }}>
          L'IA génère pour vous annonces, posts LinkedIn, captions Instagram et emails clients.
        </p>
        <SignUpButton mode="modal">
        ...
        <div style={{ color: "rgba(212,189,150,0.4)", fontSize: 11, marginTop: "1rem" }}>14 jours gratuits · Sans carte bancaire</div>
      ...
      <div style={{ maxWidth: 1000, margin: "0 auto", padding: "3.5rem 1.5rem" }}>
        <div style={{ textAlign: "center", marginBottom: "2.5rem" }}>
          <div style={{ fontSize: 10, letterSpacing: "0.25em", textTransform: "uppercase", color: "#8B7355", marginBottom: "0.75rem" }}>◆ &nbsp; Fonctionnalités</div>
          <h2 style={{ fontSize: "clamp(1.3rem, 4vw, 1.8rem)", fontWeight: "normal", color: "#2C2416" }}>Tout ce dont vous avez besoin</h2>
        </div>
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(280px, 1fr))", gap: "1rem" }}>
          {features.map((f, i) => (
            <div key={i} style={{ background: "#FFFDF9", border: "1px solid #E8DFCF", borderRadius: 2, padding: "1.5rem", boxShadow: "0 2px 12px rgba(44,36,22,0.06)" }}>
              <div style={{ color: "#8B7355", fontSize: 18, marginBottom: "0.6rem" }}>{f.icon}</div>
      ...
      <div style={{ background: "#2C2416", padding: "3.5rem 1.5rem", textAlign: "center" }}>
        <div style={{ fontSize: 10, letterSpacing: "0.25em", textTransform: "uppercase", color: "rgba(212,189,150,0.5)", marginBottom: "0.75rem" }}>◆ &nbsp; Aperçu</div>
        <h2 style={{ fontSize: "clamp(1.3rem, 4vw, 1.8rem)", fontWeight: "normal", color: "#FAF7F2", marginBottom: "2.5rem" }}>Simple, rapide, efficace</h2>
        <div style={{ maxWidth: 700, margin: "0 auto", background: "#FFFDF9", borderRadius: 4, border: "1px solid #E8DFCF", padding: "1.5rem", textAlign: "left", boxShadow: "0 20px 60px rgba(0,0,0,0.3)" }}>
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(220px, 1fr))", gap: "1.5rem" }}>
            <div>
              <div style={{ fontSize: 10, letterSpacing: "0.15em", textTransform: "uppercase", color: "#8B7355", marginBottom: "1rem", borderBottom: "1px solid #E8DFCF", paddingBottom: "0.5rem" }}>◈ &nbsp; Informations</div>
              {[["Type", "Maison"], ["Ville", "Bordeaux"], ["Surface", "120 m²"], ["Prix", "395 000 €"]].map(([label, val]) => (
              ...
              <div style={{ background: "#2C2416", color: "#D4BD96", padding: "0.6rem", borderRadius: 2, textAlign: "center", fontSize: 10, letterSpacing: "0.15em", textTransform: "uppercase", marginTop: "0.75rem" }}>✦ &nbsp; Générer</div>
            </div>
            <div>
              <div style={{ fontSize: 10, letterSpacing: "0.15em", textTransform: "uppercase", color: "#8B7355", marginBottom: "1rem", borderBottom: "1px solid #E8DFCF", paddingBottom: "0.5rem" }}>◈ &nbsp; Annonce générée</div>
              <div style={{ fontSize: "0.8rem", lineHeight: 1.8, color: "#2C2416" }}>
                <strong>Maison d'exception — Bordeaux Chartrons</strong><br /><br />
                Nichée au cœur des Chartrons, cette élégante maison de 120 m² vous séduira par son caractère unique.<br /><br />
                Jardin privatif, cuisine rénovée, parquet ancien et luminosité exceptionnelle.<br /><br />
      ...
      <div style={{ maxWidth: 1000, margin: "0 auto", padding: "3.5rem 1.5rem" }}>
        <div style={{ textAlign: "center", marginBottom: "2.5rem" }}>
          <div style={{ fontSize: 10, letterSpacing: "0.25em", textTransform: "uppercase", color: "#8B7355", marginBottom: "0.75rem" }}>◆ &nbsp; Témoignages</div>
          <h2 style={{ fontSize: "clamp(1.3rem, 4vw, 1.8rem)", fontWeight: "normal", color: "#2C2416" }}>Ils nous font confiance</h2>
        </div>
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(260px, 1fr))", gap: "1rem" }}>
          {testimonials.map((t, i) => (
            <div key={i} style={{ background: "#FFFDF9", border: "1px solid #E8DFCF", borderRadius: 2, padding: "1.5rem", boxShadow: "0 2px 12px rgba(44,36,22,0.06)" }}>
              <div style={{ color: "#D4BD96", fontSize: "1.3rem", marginBottom: "0.75rem" }}>❝</div>
              <div style={{ color: "#2C2416", fontSize: "0.85rem", lineHeight: 1.8, fontStyle: "italic", marginBottom: "1rem" }}>{t.text}</div>
              <div style={{ borderTop: "1px solid #E8DFCF", paddingTop: "0.75rem" }}>
                <div style={{ fontWeight: "bold", color: "#2C2416", fontSize: "0.82rem" }}>{t.name}</div>
                <div style={{ color: "#8B7355", fontSize: "0.75rem", marginTop: 2 }}>{t.role}</div>
              </div>
            </div>
          ))}
        </div>
      ...
      <div style={{ background: "#F5F0E8", padding: "3.5rem 1.5rem" }}>
        <div style={{ textAlign: "center", marginBottom: "2.5rem" }}>
          <div style={{ fontSize: 10, letterSpacing: "0.25em", textTransform: "uppercase", color: "#8B7355", marginBottom: "0.75rem" }}>◆ &nbsp; Tarifs</div>
          <h2 style={{ fontSize: "clamp(1.3rem, 4vw, 1.8rem)", fontWeight: "normal", color: "#2C2416" }}>Simple et transparent</h2>
        </div>
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(250px, 1fr))", gap: "1rem", maxWidth: 700, margin: "0 auto" }}>
          <div style={{ background: "#FFFDF9", border: "1px solid #E8DFCF", borderRadius: 2, padding: "1.75rem", boxShadow: "0 2px 12px rgba(44,36,22,0.06)" }}>
            ...
            <div style={{ color: "#8B7355", fontSize: 11, marginBottom: "1.25rem" }}>par mois</div>
          ...
          <div style={{ background: "#2C2416", border: "1px solid #2C2416", borderRadius: 2, padding: "1.75rem", boxShadow: "0 8px 30px rgba(44,36,22,0.2)", position: "relative" }}>
            <div style={{ position: "absolute", top: -11, left: "50%", transform: "translateX(-50%)", background: "#D4BD96", color: "#2C2416", fontSize: 9, letterSpacing: "0.2em", textTransform: "uppercase", padding: "3px 12px", borderRadius: 20, fontWeight: "bold", whiteSpace: "nowrap" }}>Recommandé</div>
            ...
            <div style={{ color: "rgba(212,189,150,0.5)", fontSize: 11, marginBottom: "1.25rem" }}>par mois</div>
      ...
      <div style={{ maxWidth: 700, margin: "0 auto", padding: "3.5rem 1.5rem" }}>
        <div style={{ textAlign: "center", marginBottom: "2.5rem" }}>
          <div style={{ fontSize: 10, letterSpacing: "0.25em", textTransform: "uppercase", color: "#8B7355", marginBottom: "0.75rem" }}>◆ &nbsp; FAQ</div>
          <h2 style={{ fontSize: "clamp(1.3rem, 4vw, 1.8rem)", fontWeight: "normal", color: "#2C2416" }}>Questions fréquentes</h2>
        </div>
        {faqs.map((f, i) => (
      ...
      {/* CTA FINAL */}
      <div style={{ background: "#2C2416", padding: "3.5rem 1.5rem", textAlign: "center" }}>
        <div style={{ color: "rgba(212,189,150,0.5)", fontSize: 10, letterSpacing: "0.25em", textTransform: "uppercase", marginBottom: "1.25rem" }}>✦ &nbsp; Prêt à commencer ? &nbsp; ✦</div>
        ...
        <p style={{ color: "rgba(250,247,242,0.5)", marginBottom: "1.75rem", fontSize: "0.88rem" }}>14 jours gratuits · Sans carte bancaire · Annulation à tout moment</p>
        <SignUpButton mode="modal">
